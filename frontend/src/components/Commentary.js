...
console.log(props.comment.idUser.userImg)
    ...
    <div className="displayFlex ">
        ...
        <div className="centerCenter">
          <div id="userImgComment" className="userImg " style={{backgroundImage:`url("/userImages/${props.comment.idUser.userImg}")`}}></div>
          ...
          <div className="body">
              ...
              <span className="tip tip-left"></span>
                  ...
                  {console.log(props.comment)}
                      ...
                      {!edit?<span className="comentarioTexto">{props.comment.comment}</span> : <div className="editComment" ><textarea col='1' onChange={readInput} id='edited_comment' value={editedComment}/><button onClick={send_new_comment}><span>Send</span></button></div>}
