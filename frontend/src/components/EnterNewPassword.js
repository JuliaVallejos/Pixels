    ...
    const sendPassword= async e =>{
        ...
        if(password.userPass===''|| password.userName === ''){
            Swal.fire({
                icon: 'error',
                title: 'Error :(',
                text: 'Fill both fields, please try again.',
              })
            return false
        }
        ...
        if(data && data.success){
            ...
            Swal.fire({
                icon: 'error',
                title: 'Error :(',
                text: 'Email must be a valid email and password must contain at least one number, one lowercase and one uppercase letter and six characters',
            })
            return false
        }
        else{
            Swal.fire({
                icon: 'error',
                title: 'Error :(',
                text: 'There was a failure creating the new pasword, please try again.',
            })
            return false
        }
    }
